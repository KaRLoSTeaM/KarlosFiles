...
if DevAbs:get(Karlos.."Abs:Lock:MuteNames"..msg.chat_id_) then
if Manager(msg) then
...
DevAbs:sadd(Karlos.."Abs:Mute:Names"..msg.chat_id_, MuteName)
end
...
DevAbs:srem(Karlos.."Abs:Mute:Names"..msg.chat_id_, UnMuteName)
end
end
if text == "مسح الاسماء المكتومه" and Constructor(msg) then
DevAbs:del(Karlos.."Abs:Mute:Names"..msg.chat_id_)
send(msg.chat_id_, msg.id_, "⌁︙تم مسح الاسماء المكتومه")
end
if text == "الاسماء المكتومه" and Constructor(msg) then
local AllNames = DevAbs:smembers(Karlos.."Abs:Mute:Names"..msg.chat_id_)
...
if not Manager(msg) and DevAbs:get(Karlos.."Abs:Lock:MuteNames"..msg.chat_id_) then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
if result.id_ then 
KarlosName = ((result.first_name_ or "") .. (result.last_name_ or ""))
if KarlosName then 
KarlosNames = DevAbs:smembers(Karlos.."Abs:Mute:Names"..msg.chat_id_) or ""
if KarlosNames and KarlosNames[1] then 
for i=1,#KarlosNames do 
if KarlosName:match("(.*)("..KarlosNames[i]..")(.*)") then 
...
DevAbs:set(Karlos.."Abs:Lock:MuteNames"..msg.chat_id_,true)
end
...
DevAbs:del(Karlos.."Abs:Lock:MuteNames"..msg.chat_id_)
end
end
end
